...
class EnhancedTerminalInterface:
    """Enhanced terminal interface with rich visualization and controls."""
    ...
    def __init__(self, stdscr):
        ...
        self.ai_player = EnhancedAIPlayer(self.maze)

        # Game state
        self.game_over = False
        self.won = False
        self.log_messages = ['Welcome to the Enhanced Maze Adventure!']
...
def main():
    ...
    # Initialize curses
    curses.wrapper(lambda stdscr: EnhancedTerminalInterface(stdscr).run())
